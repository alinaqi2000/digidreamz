...
function SidebarLeft({ app, fb }: { app: MyAppState, fb: FirebaseReducer.Reducer }) {
            ...
            <aside className={app.opneLeftSideBar ? "left open" : "left"}>
                ...
                <div className="sidebar-content">
                    <ul className="tabs">
                        ...
                        <li>
                            <NavLink to="/explore" onClick={(e: Event) => navigateTo(e, "/explore")}>
                                <Hash />  Explore
                            </NavLink>
                        </li>
                        <li>
                            <NavLink to="/notifications" onClick={(e: Event) => navigateTo(e, "/notifications")}>
                                <Bell />  Notifications
                            </NavLink>
                        </li>
                    </ul>
...
export default connect((appState: AppState) => ({ app: appState.app, fb: appState.firebase }))(SidebarLeft);
